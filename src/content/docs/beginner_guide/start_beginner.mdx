...
> NOTE: "Distro" just means a Linux distribution, which is a modification of GNU/Linux, tailored to a philosophy, use-case, or more.

Choosing the right distro for *you* can be hard, so for the sake of this guide, we advise you to use **Linux Mint**: an Ubuntu-based distro that is perfect for beginners, and free from Ubuntu's parent company's questionable choices.
